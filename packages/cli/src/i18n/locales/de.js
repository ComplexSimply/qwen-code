...
export default {
  ...
  'Update check skipped (registry did not respond within {{seconds}}s) — run /update to retry.':
    'Update-Prüfung übersprungen (Registry hat nicht innerhalb von {{seconds}}s geantwortet) — mit /update erneut versuchen.',
  'Update check skipped — run /update to retry.':
    'Update-Prüfung übersprungen — mit /update erneut versuchen.',
