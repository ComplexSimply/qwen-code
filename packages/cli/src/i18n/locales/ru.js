...
export default {
  ...
  'Update check skipped (registry did not respond within {{seconds}}s) — run /update to retry.':
    'Проверка обновлений пропущена (registry не ответил за {{seconds}} с) — выполните /update для повторной попытки.',
  'Update check skipped — run /update to retry.':
    'Проверка обновлений пропущена — выполните /update для повторной попытки.',
