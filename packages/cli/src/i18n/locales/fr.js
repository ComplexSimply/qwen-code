...
export default {
  ...
  'Update check skipped (registry did not respond within {{seconds}}s) — run /update to retry.':
    "Vérification des mises à jour ignorée (le registre n'a pas répondu en {{seconds}}s) — exécutez /update pour réessayer.",
  'Update check skipped — run /update to retry.':
    'Vérification des mises à jour ignorée — exécutez /update pour réessayer.',
