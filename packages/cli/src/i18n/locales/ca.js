...
export default {
  ...
  'Update check skipped (registry did not respond within {{seconds}}s) — run /update to retry.':
    "S'ha omès la comprovació d'actualitzacions (el registre no ha respost en {{seconds}}s) — executeu /update per tornar-ho a provar.",
  'Update check skipped — run /update to retry.':
    "S'ha omès la comprovació d'actualitzacions — executeu /update per tornar-ho a provar.",
